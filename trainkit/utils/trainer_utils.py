...
class LRSchedulerFactory:
    ...
    @staticmethod
    def __get_clr_scheduler(optimizer, min_lr, max_lr, batches_per_epoch, mode,
                            clr_step_size_up, clr_step_size_down, cycle_momentum,
                            **_ignored):
    ...
    @staticmethod
    def __get_cst_onecycle_scheduler(optimizer, max_lr, num_epochs, batches_per_epoch,
                                     step_frac_up, step_frac_down,
                                     init_lr_div_factor, min_lr_div_factor,
                                     **_ignored):
        lr_scheduler = CstmOneCycleLR(optimizer, max_lr=max_lr,
                                      epochs=num_epochs, steps_per_epoch=batches_per_epoch,
                                      step_frac_up=step_frac_up, step_frac_down=step_frac_down,
